...
class Auth {
  ...
  async signIn(userData) {
    ...
    _Router.default.init(); // redirects


    if (data.user.newUser == true) {
      // new user - direct to guide page
      (0, _Router.gotoRoute)('/guide');
    } else {
      // existing user - direct to home page
      (0, _Router.gotoRoute)('/dash');
    }
  }
...
class Utils {
  ...
  pageAnim() {
    ...
    _gsap.default.to(".page-content1", {
      x: "120vw",
      duration: 4,
      ease: "power2.in"
    });
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Utils":"Utils.js"}],"views/pages/signin.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["      \n      <div class=\"page-content page-centered\" style=\"top: 2%;\">\n        <div class=\"signinup-box\">\n          <img class=\"signinup-logo\" src=\"/images/logo1.svg\"> \n          <sl-form class=\"form-signup dark-theme\" @sl-submit=", ">          \n            <div class=\"input-group\">\n              <sl-input name=\"email\" type=\"email\" placeholder=\"Email\" required></sl-input>\n            </div>\n            <div class=\"input-group\">\n              <sl-input name=\"password\" type=\"password\" placeholder=\"Password\" required toggle-password></sl-input>\n            </div>\n            <sl-button class=\"submit-btn input-group\" type=\"primary\" submit style=\"width: 100%;\">Sign In</sl-button>\n          </sl-form>\n          <p>No Account? <a href=\"/signup\" @click=", ">Sign Up</a></p>\n        </div>\n      </div>\n    "]);
...
exports.default = _default;
},{"./../../App":"App.js","./../../Auth":"Auth.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Utils":"Utils.js"}],"HaircutAPI.js":[function(require,module,exports) {
"use strict";
...
class HaircutAPI {
  ...
  async updateSitRequest(requestId, requestData) {
    ...
    const response = await fetch("".concat(_App.default.apiBase, "/haircut/").concat(requestId), responseHeader); // if response not ok
  ...
  async getSitterByID(sitterID) {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/user/sitter/").concat(sitterID), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    }); // if response not ok
  ...
  async getSitterRequests() {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/haircut/sitRequest"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    }); // if response not ok
...
},{}],"views/pages/dash.js":[function(require,module,exports) {
"use strict";
...
function _templateObject7() {
  const data = _taggedTemplateLiteral(["<p>None</p>"]);
...
function _templateObject5() {
  const data = _taggedTemplateLiteral(["\n                    <div style=\"display: inline-block; width:100% \">\n                        <sl-form @sl-submit=", ">\n                          <sl-input name=\"sitterID\" value=\"", "\" style=\"display: none;\"></sl-input>\n                          <sl-input value=\"", "\" style=\"display: none;\"></sl-input>\n                          <button  class=\"buttonAnch\" submit>", "</button>   \n                        </sl-form>\n                        <sl-form @sl-submit=", ">\n                          <sl-input name=\"_id\" value=\"", "\" style=\"display: none;\"></sl-input>\n                          <sl-input name=\"sitterID\" value=\"", "\" style=\"display: none;\"></sl-input>\n                          <sl-input name=\"userID\" value=\"", "\" style=\"display: none;\"></sl-input>\n                          <sl-input name=\"petName\" value=\"", "\" style=\"display: none;\"></sl-input>\n                          <sl-button style=\"float: right; margin:2px 5px\" type=\"warning\" name=\"sitRequest\" value=\"2\" class=\"submit-btn\"submit>Reject</sl-button>\n                        </sl-form>\n                        <sl-form @sl-submit=", ">\n                          <sl-input name=\"_id\" value=\"", "\" style=\"display: none;\"></sl-input>\n                          <sl-input name=\"sitterID\" value=\"", "\" style=\"display: none;\"></sl-input>\n                          <sl-input name=\"userID\" value=\"", "\" style=\"display: none;\"></sl-input>\n                          <sl-input name=\"petName\" value=\"", "\" style=\"display: none;\"></sl-input>\n                          <sl-button style=\"float: right; margin:2px 5px\" type=\"primary\" name=\"sitRequest\" value=\"1\" class=\"submit-btn\"submit>Accept</sl-button>\n                        </sl-form>\n                      </div>\n                   \n                        <br>\n                    \n                    "]);
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n            <h1 class=\"calign\" style=\"width: 100%\"> Me and ", "</h1>\n            <div class=\"one\">\n              <img src=", ">\n            </div>\n          </div>\n          "]);
...
class ProfileView {
  ...
  async getSitterRequests() {
    try {
      this.sitRequests = await _HaircutAPI.default.getSitterRequests();
      this.render();
    } catch (err) {
  ...
  async moreInfoHandler(e) {
    ...
    const submitBtn = document.querySelector('.submit-btn');
    const formData = e.detail.formData;
    _Auth.default.sitter = formData.get('sitterID');
    const decision = formData.get('sitRequest');
    const requestId = formData.get('_id');
    submitBtn.setAttribute('loading', '');

    if (decision == null) {
      (0, _Router.gotoRoute)('/sitters');
    }

    try {
      await _HaircutAPI.default.updateSitRequest(requestId, formData);

      _Toast.default.show('Request updated');
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser && _Auth.default.currentUser.avatar ? (0, _litHtml.html)(_templateObject2(), _Auth.default.currentUser.petName, _Auth.default.currentUser && _Auth.default.currentUser.avatar ? "".concat(_App.default.apiBase, "/images/").concat(_Auth.default.currentUser.avatar) : '') : (0, _litHtml.html)(_templateObject3()), _Auth.default.currentUser.petName, _Auth.default.currentUser.location, _Auth.default.currentUser.petType, _Auth.default.currentUser.breed, _Auth.default.currentUser.spoilRating, _Auth.default.currentUser.specialRequirements, (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM Do YYYY, @ h:mm a'), _App.default.apiBase, _Auth.default.currentUser.favourRating, this.sitRequests.map(sitRequest => (0, _litHtml.html)(_templateObject4(), _Auth.default.currentUser._id == sitRequest.sitterID && sitRequest.sitRequest == 0 ? (0, _litHtml.html)(_templateObject5(), this.moreInfoHandler.bind(this), sitRequest.userID, this.count++, sitRequest.petName, this.moreInfoHandler.bind(this), sitRequest._id, sitRequest.userID, sitRequest.sitterID, sitRequest.petName, this.moreInfoHandler.bind(this), sitRequest._id, sitRequest.userID, sitRequest.sitterID, sitRequest.petName) : (0, _litHtml.html)(_templateObject6()))), this.count == 1 ? (0, _litHtml.html)(_templateObject7()) : (0, _litHtml.html)(_templateObject8()));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../HaircutAPI":"HaircutAPI.js","moment":"../node_modules/moment/moment.js"}],"UserAPI.js":[function(require,module,exports) {
"use strict";
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM Do YYYY, @ h:mm a'), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.updateProfileSubmitHandler.bind(this), this.user.firstName, this.user.lastName, this.user.petName, this.user.location, this.user.email, this.user.breed, this.user.specialRequirements, this.user.avatar ? (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject5())));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"views/pages/sitters.js":[function(require,module,exports) {
"use strict";
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n            <h1 class=\"calign\" style=\"width: 100%\"> ", " and ", "</h1>\n            <div class=\"one\">\n              <img src=", ">\n            </div>\n          </div>\n          "]);
...
class SitterView {
  ...
  async getSitter() {
    try {
      this.Sitter = await _HaircutAPI.default.getSitterByID(_Auth.default.sitter);
      this.render();
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  ...
  async newRequestSubmitHandler(e) {
    ...
    try {
      ...
      _Toast.default.show('Request submitted');
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.Sitter && this.Sitter.avatar ? (0, _litHtml.html)(_templateObject2(), this.Sitter.firstName, this.Sitter.petName, this.Sitter && this.Sitter.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.Sitter.avatar) : '') : (0, _litHtml.html)(_templateObject3()), this.Sitter.firstName, this.Sitter.petName, this.Sitter.location, this.Sitter.petType, this.Sitter.breed, this.Sitter.spoilRating, this.Sitter.specialRequirements, (0, _moment.default)(this.Sitter.updatedAt).format('MMMM Do YYYY, @ h:mm a'), _App.default.apiBase, this.Sitter.favourRating, this.newRequestSubmitHandler.bind(this), _Auth.default.currentUser._id, this.Sitter._id, this.sitRequest, _Auth.default.currentUser.petName);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new SitterView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","moment":"../node_modules/moment/moment.js","../../HaircutAPI":"HaircutAPI.js","../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"views/pages/browse.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../HaircutAPI":"HaircutAPI.js","../../Toast":"Toast.js"}],"views/pages/haircuts.js":[function(require,module,exports) {
"use strict";
...
class HaircutsView {
  ...
  async getSitters() {
    try {
      this.sitters = await _HaircutAPI.default.getHaircuts();
      this.render();
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.sitters == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.sitters.map(sitter => (0, _litHtml.html)(_templateObject4(), sitter._id != _Auth.default.currentUser._id ? (0, _litHtml.html)(_templateObject5(), JSON.stringify(sitter._id), sitter.avatar, sitter.location, sitter.petType) : (0, _litHtml.html)(_templateObject6())))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","../../HaircutAPI":"HaircutAPI.js","../../Toast":"Toast.js"}],"views/pages/test.js":[function(require,module,exports) {
"use strict";
...
class TestView {
  ...
  render() {
    const test = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(test, _App.default.rootEl);
  }
...
var _dash = _interopRequireDefault(require("./views/pages/dash"));
...
var _sitters = _interopRequireDefault(require("./views/pages/sitters"));
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/dash":"views/pages/dash.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/sitters":"views/pages/sitters.js","./views/pages/browse":"views/pages/browse.js","./views/pages/haircuts":"views/pages/haircuts.js","./views/pages/test":"views/pages/test.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n          <a href=\"/editProfile\" @click=\"", "\">Complete Profile</a>"]);
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, _Router.anchorRoute, this.user.accessLevel == 1 && this.user.setUpComplete == false ? (0, _litElement.html)(_templateObject2(), _Router.anchorRoute) : (0, _litElement.html)(_templateObject3()), e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : '', () => (0, _Router.gotoRoute)('/dash'), () => (0, _Router.gotoRoute)('/editProfile'), () => _Auth.default.signOut(), this.menuClick, this.menuClick, () => _Auth.default.signOut());
  }
...
customElements.define('va-haircut', class Haircut extends _litElement.LitElement {
  ...
  moreInfoHandler() {
    _Auth.default.sitter = this.id.replace(/['"]+/g, '');
    (0, _Router.gotoRoute)('/sitters');
  }

  render() {
    return (0, _litElement.html)(_templateObject(), _App.default.apiBase, this.image, this.firstName, this.location, this.petType, this.moreInfoHandler.bind(this));
  }
